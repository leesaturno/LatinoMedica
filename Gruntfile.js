...
module.exports = function (grunt) {
    ...
    var fileConfig = {
         ...
         */
        app_files: {
            js: ['./client/src/assets/js/loader_build.js', '/client/src/assets/js/loader.js', 'vendor/jquery/dist/jquery.min.js'],
            copy_js: [
                ...
                'client/src/app/Appointments/*.module.js',
                'client/src/app/Common/*.js',
                'client/src/app/User/*.js',
                'client/src/app/Home/*.js',
                'client/src/app/Appointments/*.js',
                'client/src/app/Search/*.js',
                'client/src/app/Worklocation/*.js',
                'client/src/app/Badges/*.js'
            ],
            appTemplates: [
                'client/src/app/Common/*.tpl.html',
                'client/src/app/User/*.tpl.html',
                'client/src/app/Home/*.tpl.html',
                'client/src/app/Appointments/*.tpl.html',
                'client/src/app/Search/*.tpl.html',
                'client/src/app/Worklocation/*.tpl.html',
                'client/src/app/Badges/*.tpl.html'
            ],
         ...
         */
        admin_files: {
            js: ['client/src/ag-admin/js/ng-admin.jwt-auth.js', 'client/src/ag-admin/js/ng-admin.app.js', 'vendor/morris.js/morris.min.js', 'vendor/raphael/raphael.js', 'vendor/angular-morris-chart/src/angular-morris-chart.min.js'],
        ...
        vendor_files: {
            ...
            css: [
                ...
                'vendor/angular-input-stars/angular-input-stars.css',
                'vendor/chosen/chosen.css',
                'vendor/angular-ui-select/dist/select.css',
                'vendor/ngGallery/src/css/ngGallery.css',
        ...
        admin_vendor_files: {
            js: [
                ...
                'vendor/ng-admin.jwt-auth/build/ng-admin.jwt-auth.js',
    ...
    var taskConfig = {
        ...
        'regex-replace': {
            'api-config': {
                src: ['public/api_explorer/index.html', 'public/api_explorer/api-docs/*.json', 'client/src/**/*.*'],
                actions: [{
                    name: 'Domain Replace',
                    search: '/abs/absproduct/public',
        ...
        sshexec: {
            dev1: {
                command: ['unzip -o -d <%= config.upload_path %> <%= config.upload_path %>/abs.zip', 'rm <%= config.upload_path %>/abs.zip'],
                options: {
                    host: '<%= config.host %>',
                    username: '<%= config.host_username %>',
                    password: '<%= config.host_password %>'
    ...
    grunt.registerTask('build', [
        ...
        'copy:build_app_assets', 'copy:build_app_assets_js', 'copy:build_ngadmin', 'copy:build_ngadmin_tpl', 'copy:build_vendor_assets', 'copy:build_appjs', 'copy:build_vendorjs',
        'ngAnnotate:build',
        'index:build',
        'admin_index:build'
    ]);
