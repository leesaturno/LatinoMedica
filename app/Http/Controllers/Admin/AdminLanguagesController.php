...
class AdminLanguagesController extends Controller
{
    ...
    {
        $languages = Language::filterByRequest($request)->paginate(20);
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($language_data, Language::GetValidationRule());
        if ($validator->passes()) {
    ...
    { 
        ...
        Language::where('id','=',$data['id'])->update(['translation_active'=>$data['type']]);
        return response()->json(['Success' => 'Language Updated'], 200);
    }
}
