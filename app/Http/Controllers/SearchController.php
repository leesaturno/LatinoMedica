        ...
        if (!empty($userIds)) {
            ...
            if (!empty($appoinmentSettings)) {
                ...
                foreach ($appoinmentSettings as $appointmentSetting) {
                    ...
                    $userSubscription = User::where('id', $appointmentSetting['user_id'])->select(['subscription_id','is_active','is_expiry'])->first();
                    if ($userSubscription->subscription_id == 9) {
                        $buildWeek = '';
                    } else {
                    ...
                    if (is_array($buildWeek) && !empty($buildWeek)) {
                        ...
                        $buildWeek['week_hender'] = true;
                    } else {
                        $buildWeek['show_button'] = 0;
                        $buildWeek['week_hender'] = false;
                    }      
