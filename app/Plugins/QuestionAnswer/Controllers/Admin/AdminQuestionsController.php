...
class AdminQuestionsController extends Controller
{
    ...
    {
        $requestData = $request->only('question', 'user_id', 'specialty_id', 'description', 'is_active', 'doctor_id');
    ...
    {
        $responseData = $request->only('question', 'user_id', 'specialty_id', 'description', 'is_active', 'doctor_id');
