...
angular.module("Common/header.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("Common/header.tpl.html",
    ...
    "                    	<a class=\"call-icon\" href=\"javascript:void(0)\">{{'Call Us:' | translate}} <span>{{$root.settings['site.contact_number']}}</span></a>\n" +
    "                    </li>\n" +
    ...
    "                	<a class=\"login\" ui-sref=\"login\" title=\"{{'Log In' | translate}}\">{{'Log In / Sign Up' | translate}}</a>\n" +
    "                </li>\n" +
    "                <li ng-if=\"$root.auth.id == NULL\">\n" +
    "					<a class=\"contact-icon\" ui-sref=\"list_your_practice()\" title=\"{{'List your practice' | translate}}\">{{'List your practice' | translate}}</a>\n" +
    "                </li>\n" +
    ...
    "                <li>\n" +
    "					<a class=\"contact-icon\" href=\"#/contactus\" title=\"{{'Contact Us' | translate}}\">{{'Contact Us' | translate}}</a>\n" +
    "                </li>\n" +
...
angular.module("User/booking_register.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/booking_register.tpl.html",
    ...
    "                          \n" +
    "							<label>\n" +
    "    <input type=\"radio\" ng-model=\"model.is_seen_before\" value=\"1\">{{\"I'm new in latinomedica\" | translate }}\n" +
    "  </label>\n" +
    "									</div>\n" +
    "									<div class=\"col-md-6\">\n" +
    "  <label>\n" +
    "    <input type=\"radio\" ng-model=\"model.is_seen_before\" value=\"0\">{{\"I have used Latinomedica before\" | translate }}\n" +
    "  </label>\n" +
    "									</div>\n" +
    "                        </div>\n" +
    "									\n" +
    ...
    "						\n" +
    "						<div class=\"form-heading\">\n" +
    "                    <h2 class=\"form-login-heading\">{{'Create your account'| translate }}\n" +
    "                      \n" +
    "                    </h2>\n" +
    "							<span>{{\"This will help you handle your appointments\" | translate}}</span>\n" +
    "                </div>\n" +
    "								<div class=\"col-md-12 location-info row\">\n" +
    "                            \n" +
    "                            <div class=\"row\">\n" +
    "                                <div class=\"col-md-6\">\n" +
    "									 <label class=\"col-sm-12 form-name\">{{'*Cellphone'| translate}}</label>\n" +
    ...
    "								 \n" +
    "                            	<div class=\"col-sm-6\">\n" +
    "                                    <label class=\"col-sm-12\">{{'*Insert your E-mail address'}}</label>\n" +
    ...
    "								<div class=\"col-sm-6\">\n" +
    "                                    <label class=\"col-sm-12\">{{'*Confirm your E-mail address'}}</label>\n" +
    ...
    "                            \n" +
    "                            <div class=\"row\">\n" +
    "								 <label class=\"col-sm-12 form-name\">{{'*Date of birth'| translate}}</label>\n" +
    "								<div class=\"col-md-4\">\n" +
    "									\n" +
    ...
    "									<label class=\"col-sm-12 form-name\"><span class=\"red\">*</span>{{\"who's is going to see the Doctor?\"| translate}}</label>\n" +
    "									\n" +
    "								<div class=\"col-md-6\">\n" +
    "                          \n" +
    "							<label>\n" +
    "    <input type=\"radio\" ng-model=\"model.is_member\" value=\"1\">{{\"Myself\" | translate }}\n" +
    "  </label>\n" +
    "									</div>\n" +
    "									<div class=\"col-md-6\">\n" +
    "  <label>\n" +
    "    <input type=\"radio\" ng-model=\"model.is_member\" value=\"2\">{{\"A family member\" | translate }}\n" +
    "  </label>\n" +
    "									</div>\n" +
    "									<div class=\"col-md-6\">\n" +
    "  <label>\n" +
    "    <input type=\"radio\" ng-model=\"model.is_member\" value=\"3\">{{\"Other person\" | translate }}\n" +
    "  </label>\n" +
    "									</div>\n" +
    "                        </div>\n" +
    "									\n" +
    ...
    "                            \n" +
    "                            <div class=\"row\">\n" +
    "								<label class=\"col-sm-12 form-name\"><span>*</span>{{'Add a new Family of Friend'| translate}}</label>\n" +
    "								<div class=\"col-md-3\">\n" +
    "									\n" +
...
angular.module("User/doctor_note.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/doctor_note.tpl.html",
    ...
    "    <div class=\"container\">\n" +
    "        <div class=\"page-head clearfix\">  \n" +
    "            <h1 class=\"pull-left\">{{'Note' | translate }}</h1>\n" +
    "        </div>\n" +
...
angular.module("User/list_your_practice.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/list_your_practice.tpl.html",
    ...
    "                <h1 data-uk-scrollspy=\"{cls:'uk-animation-slide-top', delay:100}\">{{\"Doctors thrive with\" | translate }} {{$root.settings['site.name']}}</h1>\n" +
    "                <a href=\"javascript:void(0)\" class=\"btn\" ng-click=\"gotoDiv('joinlationmedica')\">{{\"Subscribe now!\" | translate }}</a>\n" +
    "                <p>{{$root.settings['site.name']}} {{\"helps me achieve what I set out to do as a Doctor\" | translate }}</p>\n" +
    ...
    "                <li class=\"active\">\n" +
    "                    <a href=\"javascript:void(0)\">{{\"What is\" | translate }} {{$root.settings['site.name']}}{{\"?\"}}</a>\n" +
    "                </li>\n" +
    "                <li>\n" +
    "                    <a href=\"javascript:void(0)\" ng-click=\"gotoDiv('doctorsjoin')\">{{\"Why join?\" | translate }}</a>\n" +
    "                </li>\n" +
    "                <li>\n" +
    "                    <a href=\"javascript:void(0)\" ng-click=\"gotoDiv('howitworks')\">{{\"How does it work?\" | translate }}</a>\n" +
    "                </li>\n" +
    "            </ul>\n" +
    "            <a class=\"pull-right btn\" href=\"javascript:void(0)\" ng-click=\"gotoDiv('joinlationmedica')\">{{\"List your practice\" | translate }}</a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "    <!-- End: Banner Bottom -->\n" +
    "    \n" +
    ...
    "    	<div class=\"container\">\n" +
    "            <h2>{{\"Throughout the country, Doctors rely on\" | translate }} {{$root.settings['site.name']}}</h2>\n" +
    "			<h4>{{\"Your coleagues already registered\" | translate }}</h4>\n" +
    "            <p>{{\"See who is using\" | translate }} {{$root.settings['site.name']}} {{\"in your area:\" | translate }}</p>\n" +
    ...
    "                    <div class=\"input-group\">\n" +
    "                        <div class=\"input-group-addon hidden-xs\">{{\"Show me\" | translate }}</div>\n" +
    "                        <select ng-model=\"model.specialty_id\" name=\"specialty_id\" class=\"form-control\">\n" +
    "                                        <option value=\"\">{{\"Select specialty\" | translate }}</option>\n" +
    ...
    "				</div>\n" +
    "                <div class=\"col-md-1\">\n" +
    "                    <button class=\"btn btn-block\" type=\"submit\">{{\"Go\" | translate }}</button>\n" +
    "                </div>\n" +
    "            </form>\n" +
    ...
    "                </div>\n" +
    "            </div>\n" +
    "            <p class=\"col-md-12\"><a href=\"javascript:void(0)\" class=\"btn\" ng-click=\"gotoDiv('joinlationmedica')\">{{\"Subscribe Now!\" | translate }}</a></p>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "            <h3>{{\"How will patients find you\" | translate }}</h3>\n" +
    "            <a href=\"javascript:void(0)\" class=\"btn\" ng-click=\"gotoDiv('joinlationmedica')\">{{\"Create your profile\" | translate }}</a>\n" +
    "            <div class=\"row\">\n" +
    ...
    "                            <h4 class=\"media-heading\">{{\"Your Own Search List\" | translate }}</h4>\n" +
    "                            <p>{{\"Patients can find it on our website and through the application\" | translate }} {{$root.settings['site.name']}}</p>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    ...
    "                        </div>\n" +
    "                        <div class=\"media-body\">\n" +
    "                            <h4 class=\"media-heading\">{{\"Online reservations 24/7\" | translate }}</h4>\n" +
    "                            <p>{{\"Patients can view their availability and book with a tap - either 2 pm and their phones are busy, or it's 2 am and their office is closed\" | translate }}</p>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    ...
    "                            <h4 class=\"media-heading\">{{\"Custom profile of Latinomedica\" | translate }}</h4>\n" +
    "                            <p>{{\"Your profile of\" | translate }} {{$root.settings['site.name']}} {{\"is personalized with your insurance on the network, the procedures offered and their availability in real time\" | translate }}</p>\n" +
    "                        </div>\n" +
    "                        <div class=\"media-body\">\n" +
    "                            <figure>\n" +
    ...
    "                        <div class=\"media-left\">\n" +
    "                            <h4 class=\"media-heading\">{{\"Professional pictures\" | translate }}</h4>\n" +
    "                            <p>{{\"Headshots and photos of the office enhance your profile and help attract more patients. (Only available in certain areas.)\" | translate }}</p>\n" +
    "                        </div>\n" +
    "                        <div class=\"media-body\">\n" +
    "                            <figure>\n" +
    ...
    "                        <div class=\"media-left\">\n" +
    "                            <h4 class=\"media-heading\">{{\"Unlimited Locations\" | translate }}</h4>\n" +
    "                            <p>{{\"List several practice locations in your profile to help patients find the most convenient\" | translate }}</p>\n" +
    "                        </div>\n" +
    "                        <div class=\"media-body\">\n" +
    "                            <figure>\n" +
    ...
    "                        <div class=\"media-left\">\n" +
    "                            <h4 class=\"media-heading\">{{\"Patient Feedback\" | translate }}</h4>\n" +
    "                            <p>{{\"Build and Protect Your Online Reputation with Verified Reviews of Real Patients\" | translate }}</p>\n" +
    "                        </div>\n" +
    "                        <div class=\"media-body\">\n" +
    "                            <figure>\n" +
    ...
    "        <div class=\"container\">\n" +
    "            <p>{{\"Interested? Get more information today\" | translate }}</p>\n" +
    "            <a href=\"javascript:void(0)\" class=\"btn\" ng-click=\"gotoDiv('joinlationmedica')\">{{\"Register for a FREE demonstration\" | translate }}</a>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "                            </div>\n" +
    "                            <div class=\"media-body\">\n" +
    "                                <h4 class=\"media-heading\">{{\"Register immediately\" | translate }}</h4>\n" +
    "                                <p>{{\"Patients fill their papers online - all you have to do is print it. This can improve the accuracy and readability of their practice\" | translate }}</p>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    ...
    "                            </div>\n" +
    "                            <div class=\"media-body\">\n" +
    "                                <h4 class=\"media-heading\">{{\"Email reminders and text\" | translate }}</h4>\n" +
    "                                <p>{{\"His patients receive appointment reminders,\" | translate }} {{$root.settings['site.name']}} {{\"reducing no-shows and the time spent by your office staff on the phone\" | translate }}</p>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                	</div>\n" +
    "                </div>\n" +
    "                <h4>{{\"This features make latinomedica work for you\" | translate }}</h4>\n" +
    "                <div class=\"row\">\n" +
    "                    <div class=\"col-md-6 col-sm-6\">\n" +
    "                        <div class=\"media text-center calendar\">\n" +
    "                            <div class=\"media-left\">\n" +
    "                                <h4 class=\"media-heading\">{{\"Calendar Latinomedica\" | translate }}</h4>\n" +
    "                                <p>{{\"Manage availability without problems. You control your schedule and patients can choose when booking\" | translate }}</p>\n" +
    "                            </div>\n" +
    "                            <div class=\"media-body\">\n" +
    "                                <figure>\n" +
    ...
    "                            <div class=\"media-left\">\n" +
    "                                <h4 class=\"media-heading\">{{\"Account Activity\" | translate }}</h4>\n" +
    "                                <p>{{\"I'll remind you to confirm appointments and send other useful updates.\" | translate }}</p>\n" +
    "                            </div>\n" +
    "                            <div class=\"media-body\">\n" +
    "                                <figure>\n" +
    ...
    "                            <div class=\"media-left\">\n" +
    "                                <h4 class=\"media-heading\">{{\"Get synchronized\" | translate }}</h4>\n" +
    "                                <p>{{\"Our technology reads your practice management software (PMS) and automatically displays the times available in your profile \" | translate }} {{$root.settings['site.name']}}</p>\n" +
    "                            </div>\n" +
    "                            <div class=\"media-body\">\n" +
    "                                <figure>\n" +
    ...
    "            <h3>{{\"Why do Doctors join Latinomedica's?\" | translate }}</h3>\n" +
    "            <div class=\"row text-center\">\n" +
    "                <div class=\"col-md-6 col-sm-6\">\n" +
    "                    <h5>{{\"Building Patient Loyalty\" | translate }}</h5>\n" +
    "                    <p>{{\"Strengthen relationships with patients by offering\"}} {{$root.settings['site.name']}} {{\"first-class comfort - from simple booking and personalized reminders to trouble-free online registration\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-6 col-sm-6\">\n" +
    "                    <h5>{{\"Attract the patients you need\" | translate }}</h5>\n" +
    "                    <p>{{\"Your profile of\" | translate }} {{$root.settings['site.name']}} {{\"is personalized with your insurance, the procedures offered and their availability in real time\" | translate }}</p>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "        <hr />\n" +
    ...
    "                    <h5>{{\"Improve attendance\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/mejorar.png\" alt=\"mejorar\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{$root.settings['site.name']}} {{\"reminders improve attendance by 60%\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"You are always up to date\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/siempre.png\" alt=\"siempre\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"Reminders by SMS Booking You can be located Users or potential itinerants\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"High Refunds\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/reembolsos.png\" alt=\"reembolsos\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"95% of\" | translate }} {{$root.settings['site.name']}} {{\"patients are commercially insured or pay in cash\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"Large search presence\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/gran.png\" alt=\"gran\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"120 million annual searches of doctors show\" | translate }} {{$root.settings['site.name']}} {{\"in the best results\" | translate }}.</p>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "                <div class=\"row\">\n" +
    "                    <div class=\"col-md-6 col-sm-6\">\n" +
    "                        <h5>{{\"Maximize your availability\" | translate }}</h5>\n" +
    "                        <p>{{\"Fill in the last-minute openings on your calendar caused by cancellations and schedule changes. With\" | translate }} {{$root.settings['site.name']}} {{\",you are there for your patients when they need it\" | translate }}</p>\n" +
    "                    </div>\n" +
    "                    <div class=\"col-md-6 col-sm-6\">\n" +
    "                        <h5>{{\"Strengthen your reputation\" | translate }}</h5>\n" +
    "                        <p>{{$root.settings['site.name']}} {{\"protects and improves its presence on the web with verified reviews of real patients\" | translate }}</p>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    ...
    "    		<div class=\"row\">\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"Accommodate urgent needs\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/acomodar.png\" alt=\"acomodar\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"The typical\" | translate }} {{$root.settings['site.name']}} {{\"patient visits a doctor in 24 hours\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"Be available 24/7\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/estar.png\" alt=\"estar\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"45% of\" | translate }} {{$root.settings['site.name']}} {{\"appointments are booked after hours\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"Capture more comments\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/capture.png\" alt=\"capture\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"The average physician score after one year in\" | translate }} {{$root.settings['site.name']}} {{\"is 4.68 out of 5 stars\" | translate }}</p>\n" +
    "                </div>\n" +
    "                <div class=\"col-md-3 col-sm-6\">\n" +
    "                    <h5>{{\"Get verified reviews\" | translate }}</h5>\n" +
    "                    <figure>\n" +
    "                        <img src=\"assets/img/obtener.png\" alt=\"obtener\" class=\"img-responsive\" />\n" +
    "                    </figure>\n" +
    "                    <p>{{\"The average provider has 40 qualifications after one year in\" | translate }} {{$root.settings['site.name']}}</p>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    ...
    "                </button>\n" +
    "                <div class=\"item\">\n" +
    "                    <p>{{$root.settings['site.name']}} {{\"is the only one that offers patients a quick and painless way to schedule an appointment with the right doctor\" | translate }}</p>\n" +
    "                    <figure>\n" +
    ...
    "                </a>\n" +
    "            </figure>-->\n" +
    "            <h3>{{\"Join\" | translate }} {{$root.settings['site.name']}}{{\"!\"}}</h3>\n" +
    ...
    "                                    <div class=\"row\">\n" +
    "                                        <div class=\"col-md-6\">\n" +
    "                                            <label>{{\"Direct Phone number\" | translate }}</label>\n" +
    ...
    "                                <div class=\"col-sm-6\">\n" +
    "                                    <div class=\"form-group select-opt\">\n" +
    "                                        <label class=\"form-name\">{{\"City'| translate}}</label>\n" +
...
angular.module("User/login.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/login.tpl.html",
    ...
    "                   	<div class=\"clearfix\">\n" +
    "                        <h2 class=\"form-login-heading\"><span>{{\"Log in or create an account\" | translate }}</span></h2>\n" +
    "                    </div>\n" +
    "                    <h4>{{\"Access your latinomedica account\" | translate }}</h4>\n" +
...
angular.module("User/register.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/register.tpl.html",
    ...
    "                                    </div>\n" +
    "                                    <div class=\"col-sm-6\" ng-class=\"{ 'has-error' : (signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid)}\">\n" +
    "                                        <input type=\"text\" class=\"form-control\" placeholder=\"{{'Last name' | translate }}\" name=\"last_name\" ng-model=\"model.last_name\" ng-required=\"true\" ng-minlength=\"3\" ng-pattern=\"/^[a-zA-Z]*$/\">\n" +
    "                                        <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid) && (signupForm.last_name.$error.required)\">{{'Please enter your last name'| translate }} </span>\n" +
    "                                        <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid) && (signupForm.last_name.$error.minlength)\">{{ 'Minimum length is 3' | translate }}</span>\n" +
    "                                        <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid) && (signupForm.last_name.$error.pattern)\">{{ 'Enter valid name without number and space' | translate }}</span>\n" +
    "                                </div>\n" +
    ...
    "                                    </div>\n" +
    "                                    <div class=\"col-sm-6\" ng-class=\"{ 'has-error' : (signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid)}\">\n" +
    "                                        <input type=\"text\" class=\"form-control\" placeholder=\"{{'Last name' | translate }}\" name=\"last_name\" ng-model=\"model.last_name\" ng-required=\"true\" ng-minlength=\"3\" ng-pattern=\"/^[a-z A-Z]*$/\">\n" +
    "                                        <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid) && (signupForm.last_name.$error.required)\">{{'Please enter your last name'| translate }} </span>\n" +
    "                                        <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid) && (signupForm.last_name.$error.minlength)\">{{ 'Minimum length is 3' | translate }}</span>\n" +
    "                                        <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.last_name.$touched) && (signupForm.last_name.$pristine || signupForm.last_name.$invalid) && (signupForm.last_name.$error.pattern)\">{{ 'Enter valid name without number' | translate }}</span>\n" +
    "                                    </div>\n" +
    ...
    "                            <div class=\"form-group\" ng-class=\"{ 'has-error' : (signupForm.$submitted || signupForm.postal_code.$touched) && (signupForm.postal_code.$pristine || signupForm.postal_code.$invalid)}\">\n" +
    "                                <label>{{'Postal Code' | translate}}</label>\n" +
    "                                <input type=\"text\" class=\"form-control\" placeholder=\"Postal Code\" name=\"postal_code\" ng-model=\"model.postal_code\"  ng-required=\"true\" ng-minlength=\"3\" ng-maxlength=\"6\">\n" +
    "                                <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.postal_code.$touched) && (signupForm.postal_code.$pristine || signupForm.postal_code.$invalid) && (signupForm.postal_code.$error.required)\">{{'Enter Postal Code'| translate }} </span>\n" +
    "                                <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.postal_code.$touched) && (signupForm.postal_code.$pristine || signupForm.postal_code.$invalid) && (signupForm.postal_code.$error.minlength)\">{{ 'Minimum length is 3' | translate }}</span>\n" +
    "                                <span class=\"error\" ng-show=\"(signupForm.$submitted || signupForm.postal_code.$touched) && (signupForm.postal_code.$pristine || signupForm.postal_code.$invalid) && (signupForm.postal_code.$error.maxlength)\">{{ 'Maximum length is 6' | translate }}</span>\n" +
    "                            </div>\n" +
...
angular.module("User/settings.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/settings.tpl.html",
    ...
    "                        <li ng-click=\"getTemplate('User/change_password.tpl.html')\">Password</li>\n" +
    "                        <li>\n" +
    "                            <a ui-sref=\"Notifications()\">Notifications</a>\n" +
    "                        </li>\n" +
    "                        <li ng-click=\"getTemplate('User/family_friends.tpl.html')\">\n" +
    "                            <a ui-sref=\"FamilyFriends()\">Family or Friends</a>\n" +
    "                        </li>\n" +
    "                        <li ng-click=\"getTemplate('User/my_insurances.tpl.html')\">Insurance</li>\n" +
    "                        <li ng-click=\"getTemplate('User/demographic.tpl.html')\">Demographic Information</li>\n" +
    "                        <li ng-click=\"getTemplate('User/authorization.tpl.html')\">Authorization</li>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "                <div class=\"col-sm-9\">\n" +
...
angular.module("User/sidemenu.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/sidemenu.tpl.html",
    ...
    "        <a ui-sref=\"UserProfile()\">Profile</a>\n" +
    "    </li>\n" +
    "	<li ng-class=\"(currentState == 'ChangePassword') ? 'active' : ''\">\n" +
    "		<a ui-sref=\"ChangePassword()\">Password</a>\n" +
    "	</li>\n" +
...
angular.module("User/user_profile.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/user_profile.tpl.html",
    ...
    "                                                <div class=\"col-md-4\">\n" +
    "                                                    <div class=\"form-group\">\n" +
    "                                                        <label for=\"homephone\">{{'Home phone(Optional)'| translate}}</label>\n" +
    ...
    "                                                        <input type=\"text\" class=\"form-control\" name=\"postal_code\" id=\"postal_code\" placeholder=\"{{'Postal Code'| translate}}\" ng-model=\"model.user_profile.postal_code\"\n" +
    ...
    "                                    <input type=\"text\" class=\"form-control\" name=\"last_name\" id=\"last_name\" placeholder=\"{{'Last Name'| translate}}\" ng-model=\"model.user_profile.last_name\"\n" +
...
angular.module("User/user_view.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("User/user_view.tpl.html",
    ...
    "                                                <li>\n" +
    "                                                    <ul class=\"list-unstyled\">\n" +
    "                                                        <li>{{searchLists.days.today.day}}</li>\n" +
    "                                                        <li>{{searchLists.days.today.date}}</li>\n" +
    "                                                    </ul>\n" +
    "                                                </li>\n" +
    "                                                <li>\n" +
    "                                                    <ul class=\"list-unstyled\">\n" +
    "                                                        <li>{{searchLists.days.day2.day}}</li>\n" +
    "                                                        <li>{{searchLists.days.day2.date}}</li>\n" +
    "                                                    </ul>\n" +
    "                                                </li>\n" +
    "                                                <li>\n" +
    "                                                    <ul class=\"list-unstyled\">\n" +
    "                                                        <li>{{searchLists.days.day3.day}}</li>\n" +
    "                                                        <li>{{searchLists.days.day3.date}}</li>\n" +
    "                                                    </ul>\n" +
    "                                                </li>\n" +
    "                                                <li class=\"bor-none\">\n" +
    "                                                    <ul class=\"list-unstyled\">\n" +
    "                                                        <li>{{searchLists.days.day4.day}}</li>\n" +
    ...
    "                                                        <button ng-click=\"loadMore(searchLists.worklocationId)\" class=\"btn btn-dk-blue\">More&nbsp;<i class=\"fa fa-angle-down\"></i></button>\n" +
    "                                                    </span>\n" +
    "                                                    <span class=\"showless_btn js-showless_btn{{searchLists.worklocationId}} hide\">\n" +
    "                                                        <button ng-click=\"showLess(searchLists.worklocationId)\" class=\"btn btn-red\">Less&nbsp;<i class=\"fa fa-angle-up\"></i></button>\n" +
    "                                                    </span>\n" +
    "                                                </div>\n" +
    "                                            </div>\n" +
    "                                        </div>\n" +
    ...
    "                        <div class=\"field-data\" hm-read-more hm-text=\"{{model.user.user_profile.board_certifications}}\" hm-limit=\"500\" hm-more-text=\"read more\"\n" +
    ...
    "                        <div class=\"field-data\" hm-read-more hm-text=\"{{model.user.user_profile.about_me}}\" hm-limit=\"500\" hm-more-text=\"read more\"\n" +
    "                            hm-less-text=\"read less\" hm-dots-class=\"dots\" hm-link-class=\"links\">\n" +
    "                        </div>\n" +
    "                    </div>\n" +
...
angular.module("Home/home.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("Home/home.tpl.html",
    ...
    "               <img src=\"assets/img/logo.png\" alt=\"logo\" class=\"img-responsive\"/>\n" +
    "            </figure>\n" +
    "            <h1 data-uk-scrollspy=\"{cls:'uk-animation-slide-top', delay:100}\">{{\"Surprised! Find a Doctor\" | translate }}</h1>\n" +
    "            <h3 data-uk-scrollspy=\"{cls:'uk-animation-slide-top', delay:100}\">{{\"Your Medical Directory\" | translate }}</h3>\n" +
    "            <h5 data-uk-scrollspy=\"{cls:'uk-animation-slide-top', delay:100}\">{{\"Only medical and health professionals\" | translate }}</h5>\n" +
    ...
    "                	<h2>{{\"Are you a Doctor Five Star?\" | translate }}</h2>\n" +
    "                    <h3>{{\"List your practice to reach millions of patients\" | translate }}</h3>\n" +
    "                    <ul class=\"list-unstyled\">\n" +
    "                    	<li>{{\"Attract and attract new patients\" | translate }}</li>\n" +
    "                        <li>{{\"Build and strengthen their online reputation\" | translate }}</li>\n" +
    "                        <li>{{\"Provide premium patient experience\" | translate }}</li>\n" +
    "                    </ul>\n" +
    "                    <a href=\"#/users/practice\" class=\"btn\" ng-if=\"!$root.auth\">{{\"List your practice in\" | translate }} {{$root.settings['site.name']}}</a>\n" +
    "                </div>\n" +
    ...
    "                </div>\n" +
    "                <div class=\"col-md-5\">\n" +
    "                	<h2>{{\"Get the application\" | translate }} {{$root.settings['site.name']}}</h2>\n" +
    "                    <ul class=\"list-unstyled\">\n" +
    "                    	<li>{{\"Check the map of doctors in your insurance network\" | translate }}</li>\n" +
    "                        <li>{{\"See patient comments to help you choose the right doctor\" | translate }}</li>\n" +
    "                        <li>{{\"See schedule any doctor available, and click to book instantly\" | translate }}</li>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    ...
    "                <h2>{{\"Featured Specialists\" | translate }}</h2>\n" +
    ...
    "    	<div class=\"container\">\n" +
    "        	<h2 data-uk-scrollspy=\"{cls:'uk-animation-fade', delay:100}\">{{\"Find Doctor by\" | translate }}{{\"...\"}}</h2>\n" +
    "            <div class=\"row\">\n" +
    ...
    "                            </li>\n" +
    "                            <li>\n" +
    "                          		<a class=\"btn-more\" ng-click=\"$parent.citiesliList=citiesliLists.length\" ng-if=\"citiesliList==9\">{{\"More\" | translate }}{{\"...\"}}</a>\n" +
    "                                <a class=\"btn-more\" ng-click=\"$parent.citiesliList=9\" ng-if=\"citiesliList!=9\">{{\"Less\" | translate }}</a>\n" +
    "                            </li>\n" +
    "                        </ul>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                            </li>\n" +
    "                            <li>\n" +
    "                          		<a class=\"btn-more\" ng-click=\"$parent.specialtyliList=specialtyliLists.length\" ng-if=\"specialtyliList==9\">{{\"More\" | translate }}{{\"...\"}}</a>\n" +
    "                                <a class=\"btn-more\" ng-click=\"$parent.specialtyliList=9\" ng-if=\"specialtyliList!=9\">{{\"Less\" | translate }}</a>\n" +
    "                            </li>\n" +
    "                        </ul>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    ...
    "                        <h4><span>{{\"Insurance\" | translate }}</span></h4>\n" +
    ...
    "                            </li>\n" +
    "                            <li>\n" +
    "                          		<a class=\"btn-more\" ng-click=\"$parent.insurance=insurances.length\" ng-if=\"insurance==9\">{{\"More\" | translate }}{{\"...\"}}</a>\n" +
    "                                <a class=\"btn-more\" ng-click=\"$parent.insurance=9\" ng-if=\"insurance!=9\">{{\"Less\" | translate }}</a>\n" +
    "                            </li>\n" +
    "                        </ul>\n" +
    "                    </div>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "            <p>{{\"Or search by Name\" | translate }}{{\",\"}} <span><a href=\"#/users/practice\">{{\"Practice\" | translate }}</a></span>{{\",\"}} <span><a href=\"#/users/practice\">{{\"Procedure\" | translate }}</a></span> {{\" or Clinic\" | translate }}</p>\n" +
    "       	</div>\n" +
    "   	</div>\n" +
    "	<!-- End: Find Doctor -->\n" +
    "    \n" +
    ...
    "    	<div class=\"clients\">\n" +
    "        	<div class=\"container\">\n" +
    "            	<h2 class=\"text-center\">{{\"Patients are losing patience when trying to access your attention\" | translate }}</h2>\n" +
    "                <p class=\"text-center\">{{\"See why we are the perfect partner for health systems\" | translate }}</p>\n" +
    "                <ul class=\"list-inline row\">\n" +
    ...
    "                    </li>\n" +
    "                </ul>\n" +
    "                <p class=\"text-center\"><a class=\"btn\" href=\"#/users/practice\">{{\"Join us and our partners\" | translate }}</a></p>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    <!-- End: Clients -->\n" +
    "    \n" +
...
angular.module("Appointments/appointment_booking_appt_info.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("Appointments/appointment_booking_appt_info.tpl.html",
    ...
    "                    <div class=\"form-group\">\n" +
    "                        <h4>{{\"Have you used\" | translate }} {{$root.settings['site.name']}} {{\"before\" | translate }} {{\"?\"}}</h4>\n" +
    "                        <p>{{\"We will use the information from your last visit\" | translate }}</p>\n" +
    "                        <div>\n" +
    "                            <div class=\"radio\">\n" +
    "                                <label>\n" +
    "                                    <input class=\"hide\" type=\"radio\" ng-model=\"model.formFields.is_used_before\" name=\"is_used_before\" value=\"1\">\n" +
    "                                    <span></span>{{\"I'm new in\" | translate }} {{$root.settings['site.name']}}\n" +
    "                                </label>\n" +
    "                            </div>\n" +
    "                            <div class=\"radio\">\n" +
    "                                <label>\n" +
    "                                    <input class=\"hide\" type=\"radio\" ng-model=\"model.formFields.is_used_before\" name=\"is_used_before\" value=\"2\">\n" +
    "                                    <span></span>{{\"I have used\" | translate }} {{$root.settings['site.name']}} {{\" before\" | translate }}\n" +
    "                                </label>\n" +
    "                            </div>\n" +
    "                        </div>\n" +
    "                    </div>\n" +
    ...
    "                            <div class=\"clearfix\">\n" +
    "                                <h2 class=\"form-login-heading\">{{\"Log in or create an account\" | translate }}</h2>\n" +
    "                            </div>\n" +
    "                            <h5>{{\"Access your\" | translate }} {{$root.settings['site.name']}} {{\"account\" | translate }}</h5>\n" +
    "                            <div class=\"form-group email\" ng-class=\"{ 'has-error' : (loginForm.$submitted || loginForm.email.$touched) && (loginForm.email.$pristine || loginForm.email.$invalid)}\">\n" +
    "                                <div class=\"col-md-10\">\n" +
    "                                    <div class=\"row\">\n" +
    "                                        <!--<label>{{'E-mail'}}</label>-->\n" +
    ...
    "                        <div class=\"form-body\">\n" +
    "                            <div class=\"form-heading\">\n" +
    "                                <h2 class=\"form-login-heading\">{{\"Create your account\" | translate }}</h2>\n" +
    "                                <span>{{\"This will help you handle your appointments\" | translate }}</span>\n" +
    "                            </div>\n" +
    ...
    "                            <div class=\"form-group\">\n" +
    "                                <div class=\"row\">\n" +
    "                                    <label class=\"col-sm-12 form-name\">{{\"Name\" | translate }}</label>\n" +
    "                                    <div class=\"col-sm-6\" ng-class=\"{ 'has-error' : (signupForm.$submitted || signupForm.first_name.$touched) && (signupForm.first_name.$pristine || signupForm.first_name.$invalid)}\">\n" +
    ...
    "                            <label class=\"form-name\">{{\"Will you use your health insurance?\" | translate }}</label>\n" +
    ...
    "								<h4>{{noInsurance | translate }}</h4>\n" +
    "							</div>\n" +
    "						</div>\n" +
    "                        <div class=\"form-group dropdown-block select-opt\">\n" +
    "                            <label class=\"form-name\">{{\"What'\\s the reason of your visit?\" | translate }}</label>\n" +
    ...
    "                            <button class=\"btn btn-green\" type=\"submit\">{{\"Book for Free\" | translate }}</button>\n" +
    "                        </div>\n" +
    "                    </form>\n" +
    "                </div>\n" +
    "                <div ng-if=\"$root.auth.role_id == model.ConstUserType.Doctor\">\n" +
...
angular.module("Appointments/appointment_booking_confirm.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("Appointments/appointment_booking_confirm.tpl.html",
    ...
    "                <button ng-click=\"finalConfirm()\" class=\"btn btn-green confirm\">Confirm Your Appointment </button> \n" +
    "                <button ng-click=\"bookingCancel()\" class=\"btn cancel\">Cancel Booking </button> \n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</section>");
...
angular.module("Appointments/booking_breadcrum.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("Appointments/booking_breadcrum.tpl.html",
    "<ol class=\"breadcrumb\">\n" +
    "    <li ng-class=\"(stepStatus >= '1') ? 'active':''\"><a href=\"javascript:void(0);\">{{\"Patient Info\" | translate }}</a></li>\n" +
    "    <li ng-class=\"(stepStatus >= '2') ? 'active':''\"><a href=\"javascript:void(0);\">{{\"Appointment Info\" | translate }}</a></li>\n" +
    "    <!--<li ng-class=\"(stepStatus >= '3') ? 'active':''\"><a href=\"javascript:void(0);\">{{\"Details\" | translate }}</a></li>-->\n" +
    "    <li ng-class=\"(stepStatus == '4') ? 'active':''\"><a href=\"javascript:void(0);\">{{\"You Finished\" | translate }}</a></li>\n" +
    "</ol>");
}]);
...
angular.module("Search/search.tpl.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("Search/search.tpl.html",
    ...
    "                    <div class=\"row\">\n" +
    "                        <div class=\"form-group speciality col-md-6\">\n" +
    "                            <div angucomplete-alt id=\"ex1\" ng-model=\"model.doctor\" placeholder=\"{{'Specialty, Doctors Name'| translate }}\" maxlength=\"50\" pause=\"100\" selected-object=\"selectedCountry\" local-data=\"autocomplete\" search-fields=\"name\" title-field=\"name\" minlength=\"1\" image-field=\"image\" input-class=\"form-control form-control-small\" match-class=\"highlight\" ></div>\n" +
    "                        </div>\n" +
    "                        <div class=\"form-group city col-md-2\">\n" +
    ...
    "                                <li ng-click=\"model.formFilter(2,0)\" ng-class=\"(model.appointment == '' || model.appointment == undefined) ? 'active' : ''\"><a href=\"javascript:void(0)\">{{'Any Day'| translate }}</a></li>\n" +
    "                                <li ng-click=\"model.formFilter(2,1)\" ng-class=\"(model.appointment == 'today') ? 'active' : ''\"><a href=\"javascript:void(0)\">{{'Today'| translate }}</a></li>\n" +
    "                                <li ng-click=\"model.formFilter(2,2)\" ng-class=\"(model.appointment == 'threeday') ? 'active' : ''\"><a href=\"javascript:void(0)\">{{'Next 3 days'| translate }}</a></li>\n" +
    ...
    "                        <a href=\"#/users/register/doctor\" class=\"pull-right\">Read More...</a>\n" +
    "                    </span>\n" +
    ...
    "                        </div>\n" +
    "                    </div>\n" +
    "                    <p>{{'Or search by Name,'| translate }}, <span>{{'Practice'| translate }}</span>, <span>{{'Comments'| translate }}</span>, <span>{{'Hospital'| translate }}</span>, <span>{{'Language'| translate }}</span></p>\n" +
    "                </div>\n" +
    "                <!-- End: Find Doctor -->\n" +
    "   			</div>\n" +
    "		</div>\n" +
